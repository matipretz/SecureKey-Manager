...
public class Juser {
    public static String FILE_PATH = "data/users"; // Ruta del archivo donde se guardarán las passwords
    ...
    public static void createUser(Scanner scanner) {
        ...
        while (Jfun.verificar(user, null, Juser.FILE_PATH)) {
            Jfun.clear();
            System.out.print(">> El nombre de usuario ya está en uso.\n>> Ingrese su nombre de usuario:\n>> ");
            user = scanner.nextLine();
        }
        try (PrintWriter writer = new PrintWriter(new FileWriter(Juser.FILE_PATH, true))) {
    ...
    public static void logIn(Scanner scanner) {
        ...
        if (Jfun.verificar(user, password, Juser.FILE_PATH)) {
            Jfun.clear();
